...
function BindingData() {
    ...
    $("#data-table-fav").bootstrapTable({
        ...
        //handler address
        url: basicDomain + "articlelist/",
        pagination: true, //pager 是否分页
        pageSize: 20,  //pagesize 每页条数
        ...
        },
        {
            ...
            formatter: function (value, row, index, field) {
                var display = "";
                //display = "<a class=\"btn btn-cyan\" href=\"javascript:RemoveFav(" + value + ");\">取消收藏</a>";
                return display;
